            ...
            <div className="offcanvas offcanvas-start" data-bs-backdrop="static" tabIndex="-1" id="staticBackdrop" aria-labelledby="staticBackdropLabel">
                ...
                <div className="offcanvas-body">
                    ...
                    <ul className="nav flex-column">
                        ...
                        <li className="nav-item"><a className="nav-link" href="/reportissue"><i className="bi bi-plus-circle me-2"></i> New Announcement</a></li>
                        <li className="nav-item"><a className="nav-link" href="/recentreport"><i className="bi bi-file-earmark-arrow-up me-2"></i> Export Data</a></li>
                        <li className="nav-item"><a className="nav-link" href="/adminrecentreport"><i className="bi bi-file-text me-2"></i> Recent Reports</a></li>
